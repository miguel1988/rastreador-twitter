...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <p><h3>SIGUE LA HUELLA EN  TWITTER</h3></p>
    ...
    <p>
      ...
      <br/>
    <br/>Tweets: {{texto}}
    <br/>Fecha tweet: {{fecha}} 
    <br/>
    <br/>Autor: {{autor}}
    <p><img src="{{imagen}}"/></p>
    <br/>Ahora usted lo sigue por twitter
    </p>
    <h4>Muchas gracias por utilizar nuestro servicio</h4>
    <p> <a href="http://rastreadora-migueavila.rhcloud.com/">Realizar otro rastreo con otra palabra</a></p>
  </body>
</html>
